...
class FindUsersByUsernameFromExternalPlatformServiceImplTest {

    private static final String REALM = "realm";

    private KeycloakAdminApi keycloakAdminApi;
    private FindUsersByUsernameFromExternalPlatformServiceImpl service;
    ...
    void setup() {
        ...
        service = new FindUsersByUsernameFromExternalPlatformServiceImpl(keycloakAdminApi, keycloakProperties);
    }
    ...
    void shouldListUsersWithPaginationAndTotal() {
        ...
        final var page = service.listExternalUsersByFilter(search, pageable);

        assertThat(page.getTotalElements()).isEqualTo(total);
        assertThat(page.getNumber()).isZero();
        assertThat(page.getSize()).isEqualTo(5);
        assertThat(page.getContent()).hasSize(1);
        final var first = page.getContent().getFirst();
    ...
    void shouldBuildFullNameWithNormalizationAndFallback(String firstName, String lastName, String expectedFullName, String username) {
        ...
        assertThat(page.getContent()).hasSize(1);
        final var resp = page.getContent().getFirst();
